...
While Strudel can be used as a library in any JavaScript codebase, its main, reference user interface is the Strudel REPL[1][1], which is a browser-based live coding environment. This live code editor is dedicated to manipulating Strudel patterns while they play. The REPL features built-in visual feedback, highlighting which elements in the patterned (mini-notation) sequences are influencing the event that is currently being played. This feedback is designed to support both learning and live use of Strudel.
...
- the mini notation is [implemented as a PEG grammar][2], living in the [mini package][3]
- it is based on [krill][4] by Mdashdotdashn
- the peg grammar is used to generate a parser with [peggyjs][5]
...
See the separate page on Vim shortcuts for a quick reference: [/technical-manual/vim][6]
...
Note that the above code is simplified for illustrative purposes. The actual implementation has to work around imprecise callbacks of `setInterval`. More about the implementation details can be read in [this blog post][7].
...
I want to help, how do I contribute to the [Docs][8]?

## Footnotes

1. REPL stands for read, evaluate, print/play, loop. It is friendly jargon for an interactive programming interface from computing heritage, usually for a commandline interface but also applied to live coding editors. [↩][9]

[1]: https://strudel.cc/technical-manual/repl/#user-content-fn-1
[2]: https://codeberg.org/uzu/strudel/src/branch/talk/packages/mini/krill.pegjs
[3]: https://codeberg.org/uzu/strudel/src/branch/main/packages/mini
[4]: https://github.com/Mdashdotdashn/krill
[5]: https://peggyjs.org/
[6]: https://strudel.cc/technical-manual/vim/
[7]: https://loophole-letters.vercel.app/web-audio-scheduling
[8]: https://strudel.cc/technical-manual/docs/
[9]: https://strudel.cc/technical-manual/repl/#user-content-fnref-1
